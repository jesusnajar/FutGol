...
#define nURLTablePositions     @"http://futgol.x10host.com/Futgol/Endpoints/Get_Table.php?"

NSMutableArray *mstTeamLogo;
NSMutableArray *mstTeamName;
NSMutableArray *mstTeamGames;
NSMutableArray *mstTeamPoints;
NSMutableArray *mstTeamWons;
NSMutableArray *mstTeamLost;
NSMutableArray *mstTeamDrawns;
NSMutableArray *mstTeamGoalsFavor;
NSMutableArray *mstTeamGoalsAgainst;

@implementation TablePositionsDec
/**********************************************************************************************/
...
+ (NSMutableArray *)getTablePositions {
    ...
    NSString *stLeague             = @"1";
    NSString *stNewURL          = [nURLTablePositions stringByAppendingString:@"league="];
    stNewURL                    = [stNewURL stringByAppendingString:stLeague];
