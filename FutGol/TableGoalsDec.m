...
#define nURLTableGoals     @"http://futgol.x10host.com/Futgol/Endpoints/Get_Table_Goals.php?"

NSMutableArray *mstPlayerPhoto;
NSMutableArray *mstPlayerName;
NSMutableArray *mstPlayerTeam;
NSMutableArray *mstPlayerGoals;

@implementation TableGoalsDec
...
+ (NSMutableArray *)getTableGoals {
    ...
    NSString *stLeague             = @"1";
    NSString *stNewURL          = [nURLTableGoals stringByAppendingString:@"league="];
