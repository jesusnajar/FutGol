...
#define nURLMatches     @"http://futgol.x10host.com/Futgol/Endpoints/Get_All_Matches_By_League.php?"

NSMutableArray *mstLocalLogo;
NSMutableArray *mstLocalName;
NSMutableArray *mstLocalGoals;
NSMutableArray *mstForeignLogo;
NSMutableArray *mstForeignName;
NSMutableArray *mstForeignGoals;
NSMutableArray *mstNumbers;

@implementation MatchesDesc
/**********************************************************************************************/
...
+ (NSMutableArray *)getMatches {
    ...
    NSString *stLeague             = @"1";
    NSString *stNewURL          = [nURLMatches stringByAppendingString:@"league="];
